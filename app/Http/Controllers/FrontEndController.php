...
class FrontEndController extends Controller
{
    ...
    public function admon(){
        $active = 'admon';
        return view('licenciatura.admon', compact($this->compact));
    }

    public function ciencias(){
        $active = 'ciencias';
        return view('licenciatura.ciencias', compact($this->compact));
    }

    public function comercio(){
        $active = 'comercio';
        return view('licenciatura.comercio', compact($this->compact));
    }

    public function derecho(){
        $active = 'derecho';
        return view('licenciatura.derecho', compact($this->compact));
    }

    public function gastro(){
        $active = 'gastro';
        return view('licenciatura.gastro', compact($this->compact));
    }

    public function merca(){
        $active = 'merca';
        return view('licenciatura.merca', compact($this->compact));
    }
