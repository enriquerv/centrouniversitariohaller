<footer class="footer container-fluid footer-instituto py-3">
	<div class="row">
		...
		<div class="col-md-4">
			<p class="sec-footer2 text-center">
				...
				<p class="text-center">
					<a href="https://www.facebook.com/CentroUniversitarioHallerOficial/" target="_blank" class="mr-3 img_footer">
					...
					<a href="https://www.instagram.com/centrouniversitariohaller/" target="_blank" class="mr-3 img_footer">
	...
	<div class="row mt-1" style="background-color: #c72242;">
		<div class="col-md-12 text-center py-1">
			<div style="font-size: 20px; color: #fff;">CENTRO UNIVERSITARIO RAFAEL HALLER</div>
		</div>
	</div>
